...
{
    public final const START_CODE_BASE       = "\x00\x00\x01";
    public final const VIDEO_PICTURE_START   = "\x00\x00\x01\x00";
    public final const VIDEO_USER_DATA_START = "\x00\x00\x01\xB2";
    public final const VIDEO_SEQUENCE_HEADER = "\x00\x00\x01\xB3";
    public final const VIDEO_SEQUENCE_ERROR  = "\x00\x00\x01\xB4";
    public final const VIDEO_EXTENSION_START = "\x00\x00\x01\xB5";
    public final const VIDEO_SEQUENCE_END    = "\x00\x00\x01\xB7";
    public final const VIDEO_GROUP_START     = "\x00\x00\x01\xB8";
    public final const AUDIO_START           = "\x00\x00\x01\xC0";
    ...
    public function Analyze()
    {
        ...
        do {
            ...
            if ($MPEGstreamDataOffset > (strlen((string) $MPEGstreamData) - 16384)) {
...
//
        ...
        */
        ...
        if (!empty($info['mpeg']['video']['bitrate_mode']) && ($info['mpeg']['video']['bitrate_mode'] == 'vbr')) {
            ...
            if (!isset($info['video']['bitrate'])) {
                ...
                $info['video']['bitrate'] = $overall_bitrate - ($info['audio']['bitrate'] ?? 0);
            }
    ...
    public static function pictureStructureTextLookup($picture_structure)
    {
        ...
        return ($lookup[$picture_structure] ?? '');
    }
