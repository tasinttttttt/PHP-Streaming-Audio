                        ...
                        if ($info['flv']['video']['videoCodec'] == GETID3_FLV_VIDEO_H264) {
                            ...
                            if ($AVCPacketType == H264_AVC_SEQUENCE_HEADER) {
                                ...
                                if (($numOfSequenceParameterSets & 0x1F) != 0) {
                                    ...
                                    if (strlen((string) $sps) == $spsSize) {	//	make sure that whole SequenceParameterSet was red
                    ...
                    if (!$found_meta) {
                        ...
                        foreach ($copykeys as $sourcekey => $destkey) {
                            if (isset($info['flv']['meta']['onMetaData'][$sourcekey])) {
                                $info['video'][$destkey] = match ($sourcekey) {
																																	'width', 'height' => intval(round($info['flv']['meta']['onMetaData'][$sourcekey])),
																																	'audiodatarate' => getid3_lib::CastAsInt(round($info['flv']['meta']['onMetaData'][$sourcekey] * 1000)),
																																	default => $info['flv']['meta']['onMetaData'][$sourcekey],
																																};
                            }
                        }
