...
class getid3_id3v1 extends getid3_handler
{
    public function Analyze()
    {
        ...
        if (substr($id3v1tag, 0, 3) == 'TAG') {
            ...
            $ParsedID3v1['title']   = static::cutfield(substr($id3v1tag, 3, 30));
            $ParsedID3v1['artist']  = static::cutfield(substr($id3v1tag, 33, 30));
            $ParsedID3v1['album']   = static::cutfield(substr($id3v1tag, 63, 30));
            $ParsedID3v1['year']    = static::cutfield(substr($id3v1tag, 93, 4));
            ...
            $ParsedID3v1['comment'] = static::cutfield($ParsedID3v1['comment']);

            $ParsedID3v1['genre'] = static::LookupGenreName($ParsedID3v1['genreid']);
            ...
            $GoodFormatID3v1tag = static::GenerateID3v1Tag($ParsedID3v1['title'], $ParsedID3v1['artist'], $ParsedID3v1['album'], $ParsedID3v1['year'], (isset($ParsedID3v1['genre']) ? static::LookupGenreID($ParsedID3v1['genre']) : false), $ParsedID3v1['comment'], (!empty($ParsedID3v1['track']) ? $ParsedID3v1['track'] : ''));
