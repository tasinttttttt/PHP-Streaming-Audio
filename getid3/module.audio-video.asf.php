...
class getid3_asf extends getid3_handler
{
    public function __construct(getID3 $getid3)
    {
        ...
        $GUIDarray = static::KnownGUIDs();
        foreach ($GUIDarray as $GUIDname => $hexstringvalue) {
            if (!defined($GUIDname)) {
                define($GUIDname, static::GUIDtoBytestring($hexstringvalue));
            }
        }
    }
    ...
    public function Analyze()
    {
        ...
        $thisfile_asf_headerobject['objectid_guid'] = static::BytestringToGUID($thisfile_asf_headerobject['objectid']);
        if ($thisfile_asf_headerobject['objectid'] != \GETID3_ASF_HEADER_OBJECT) {
            unset($info['fileformat'], $info['asf']);
            return $this->error('ASF header GUID {'.static::BytestringToGUID($thisfile_asf_headerobject['objectid']).'} does not match expected "GETID3_ASF_Header_Object" GUID {'.static::BytestringToGUID(\GETID3_ASF_HEADER_OBJECT).'}');
        }
        ...
        for ($HeaderObjectsCounter = 0; $HeaderObjectsCounter < $thisfile_asf_headerobject['headerobjects']; $HeaderObjectsCounter++) {
            ...
            $offset += 16;
            $NextObjectGUIDtext = static::BytestringToGUID($NextObjectGUID);
            ...
            switch ($NextObjectGUID) {
                ...
                case \GETID3_ASF_FILE_PROPERTIES_OBJECT:
                    ...
                    $offset += 16;
                    $thisfile_asf_filepropertiesobject['fileid_guid']        = static::BytestringToGUID($thisfile_asf_filepropertiesobject['fileid']);
                    ...
                    $thisfile_asf_filepropertiesobject['creation_date_unix'] = static::FILETIMEtoUNIXtime($thisfile_asf_filepropertiesobject['creation_date']);
                    $offset += 8;
                    ...
                    if ($thisfile_asf_filepropertiesobject['flags']['broadcast']) {
                        ...
                        $info['playtime_seconds'] = ($thisfile_asf_filepropertiesobject['play_duration'] / 10_000_000) - ($thisfile_asf_filepropertiesobject['preroll'] / 1000);
                ...
                case \GETID3_ASF_STREAM_PROPERTIES_OBJECT:
                    ...
                    $offset += 16;
                    $StreamPropertiesObjectData['stream_type_guid']   = static::BytestringToGUID($StreamPropertiesObjectData['stream_type']);
                    $StreamPropertiesObjectData['error_correct_type'] = substr($ASFHeaderData, $offset, 16);
                    $offset += 16;
                    $StreamPropertiesObjectData['error_correct_guid'] = static::BytestringToGUID($StreamPropertiesObjectData['error_correct_type']);
                ...
                case \GETID3_ASF_HEADER_EXTENSION_OBJECT:
                    ...
                    $offset += 16;
                    $thisfile_asf_headerextensionobject['reserved_1_guid']     = static::BytestringToGUID($thisfile_asf_headerextensionobject['reserved_1']);
                    if ($thisfile_asf_headerextensionobject['reserved_1'] != \GETID3_ASF_RESERVED_1) {
                        $info['warning'][] = 'header_extension_object.reserved_1 GUID ('.static::BytestringToGUID($thisfile_asf_headerextensionobject['reserved_1']).') does not match expected "GETID3_ASF_Reserved_1" GUID ('.static::BytestringToGUID(\GETID3_ASF_RESERVED_1).')';
                        //return false;
                        break;
                    }
                ...
                case \GETID3_ASF_CODEC_LIST_OBJECT:
                    ...
                    $offset += 16;
                    $thisfile_asf_codeclistobject['reserved_guid']             = static::BytestringToGUID($thisfile_asf_codeclistobject['reserved']);
                    if ($thisfile_asf_codeclistobject['reserved'] != static::GUIDtoBytestring('86D15241-311D-11D0-A3A4-00A0C90348F6')) {
                        $info['warning'][] = 'codec_list_object.reserved GUID {'.static::BytestringToGUID($thisfile_asf_codeclistobject['reserved']).'} does not match expected "GETID3_ASF_Reserved_1" GUID {86D15241-311D-11D0-A3A4-00A0C90348F6}';
                        //return false;
                        break;
                    }
                    ...
                    for ($CodecEntryCounter = 0; $CodecEntryCounter < $thisfile_asf_codeclistobject['codec_entries_count']; $CodecEntryCounter++) {
                        ...
                        if ($thisfile_asf_codeclistobject_codecentries_current['type_raw'] == 2) { // audio codec
                            ...
                            if (!str_contains($thisfile_asf_codeclistobject_codecentries_current['description'], ',')) {
                                ...
                                [$AudioCodecBitrate, $AudioCodecFrequency, $AudioCodecChannels] = explode(',', (string) static::TrimConvert($thisfile_asf_codeclistobject_codecentries_current['description']));
                                $thisfile_audio['codec'] = static::TrimConvert($thisfile_asf_codeclistobject_codecentries_current['name']);
                                ...
                                switch ($AudioCodecFrequency) {
                                    ...
                                    default:
                                        $info['warning'][] = 'unknown frequency: "'.$AudioCodecFrequency.'" ('.static::TrimConvert($thisfile_asf_codeclistobject_codecentries_current['description']).')';
                                        break;
                                }
                ...
                case \GETID3_ASF_SCRIPT_COMMAND_OBJECT:
                    ...
                    $offset += 16;
                    $thisfile_asf_scriptcommandobject['reserved_guid']        = static::BytestringToGUID($thisfile_asf_scriptcommandobject['reserved']);
                    if ($thisfile_asf_scriptcommandobject['reserved'] != static::GUIDtoBytestring('4B1ACBE3-100B-11D0-A39B-00A0C90348F6')) {
                        $info['warning'][] = 'script_command_object.reserved GUID {'.static::BytestringToGUID($thisfile_asf_scriptcommandobject['reserved']).'} does not match expected "GETID3_ASF_Reserved_1" GUID {4B1ACBE3-100B-11D0-A39B-00A0C90348F6}';
                        //return false;
                        break;
                    }
                ...
                case \GETID3_ASF_MARKER_OBJECT:
                    ...
                    $offset += 16;
                    $thisfile_asf_markerobject['reserved_guid']        = static::BytestringToGUID($thisfile_asf_markerobject['reserved']);
                    if ($thisfile_asf_markerobject['reserved'] != static::GUIDtoBytestring('4CFEDB20-75F6-11CF-9C0F-00A0C90349CB')) {
                        $info['warning'][] = 'marker_object.reserved GUID {'.static::BytestringToGUID($thisfile_asf_markerobject['reserved_1']).'} does not match expected "GETID3_ASF_Reserved_1" GUID {4CFEDB20-75F6-11CF-9C0F-00A0C90349CB}';
                        break;
                    }
                ...
                case \GETID3_ASF_BITRATE_MUTUAL_EXCLUSION_OBJECT:
                    ...
                    $thisfile_asf_bitratemutualexclusionobject['reserved_guid']        = static::BytestringToGUID($thisfile_asf_bitratemutualexclusionobject['reserved']);
                    $offset += 16;
                    if (($thisfile_asf_bitratemutualexclusionobject['reserved'] != \GETID3_ASF_MUTEX_BITRATE) && ($thisfile_asf_bitratemutualexclusionobject['reserved'] != \GETID3_ASF_MUTEX_UNKNOWN)) {
                        $info['warning'][] = 'bitrate_mutual_exclusion_object.reserved GUID {'.static::BytestringToGUID($thisfile_asf_bitratemutualexclusionobject['reserved']).'} does not match expected "GETID3_ASF_Mutex_Bitrate" GUID {'.static::BytestringToGUID(\GETID3_ASF_MUTEX_BITRATE).'} or  "GETID3_ASF_Mutex_Unknown" GUID {'.static::BytestringToGUID(\GETID3_ASF_MUTEX_UNKNOWN).'}';
                        //return false;
                        break;
                    }
                ...
                case \GETID3_ASF_ERROR_CORRECTION_OBJECT:
                    ...
                    $offset += 16;
                    $thisfile_asf_errorcorrectionobject['error_correction_guid'] = static::BytestringToGUID($thisfile_asf_errorcorrectionobject['error_correction_type']);
                    ...
                    switch ($thisfile_asf_errorcorrectionobject['error_correction_type']) {
                        ...
                        default:
                            $info['warning'][] = 'error_correction_object.error_correction_type GUID {'.static::BytestringToGUID($thisfile_asf_errorcorrectionobject['reserved']).'} does not match expected "GETID3_ASF_No_Error_Correction" GUID {'.static::BytestringToGUID(\GETID3_ASF_NO_ERROR_CORRECTION).'} or  "GETID3_ASF_Audio_Spread" GUID {'.static::BytestringToGUID(\GETID3_ASF_AUDIO_SPREAD).'}';
                            //return false;
                            break;
                    }
                ...
                case \GETID3_ASF_CONTENT_DESCRIPTION_OBJECT:
                    ...
                    foreach ($ASFcommentKeysToCopy as $keytocopyfrom => $keytocopyto) {
                        if (!empty($thisfile_asf_contentdescriptionobject[$keytocopyfrom])) {
                            $thisfile_asf_comments[$keytocopyto][] = static::TrimTerm($thisfile_asf_contentdescriptionobject[$keytocopyfrom]);
                        }
                    }
                    break;
                ...
                case \GETID3_ASF_EXTENDED_CONTENT_DESCRIPTION_OBJECT:
                    ...
                    for ($ExtendedContentDescriptorsCounter = 0; $ExtendedContentDescriptorsCounter < $thisfile_asf_extendedcontentdescriptionobject['content_descriptors_count']; $ExtendedContentDescriptorsCounter++) {
                        ...
                        switch (static::TrimConvert(strtolower($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['name']))) {

                            case 'wm/albumartist':
                            case 'artist':
                                // Note: not 'artist', that comes from 'author' tag
                                $thisfile_asf_comments['albumartist'] = array(static::TrimTerm($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value']));
                                break;

                            case 'wm/albumtitle':
                            case 'album':
                                $thisfile_asf_comments['album']  = array(static::TrimTerm($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value']));
                                break;

                            case 'wm/genre':
                            case 'genre':
                                $thisfile_asf_comments['genre'] = array(static::TrimTerm($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value']));
                                break;

                            case 'wm/partofset':
                                $thisfile_asf_comments['partofset'] = array(static::TrimTerm($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value']));
                                break;

                            case 'wm/tracknumber':
                            case 'tracknumber':
                                // be careful casting to int: casting unicode strings to int gives unexpected results (stops parsing at first non-numeric character)
                                $thisfile_asf_comments['track'] = array(static::TrimTerm($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value']));
                            ...
                            case 'wm/track':
                                if (empty($thisfile_asf_comments['track'])) {
                                    $thisfile_asf_comments['track'] = array(1 + static::TrimConvert($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value']));
                                }
                                break;
                            ...
                            case 'year':
                            case 'date':
                                $thisfile_asf_comments['year'] = array( static::TrimTerm($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value']));
                                break;

                            case 'wm/lyrics':
                            case 'lyrics':
                                $thisfile_asf_comments['lyrics'] = array(static::TrimTerm($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value']));
                                break;
                            ...
                            case 'wm/encodingtime':
                                $thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['encoding_time_unix'] = static::FILETIMEtoUNIXtime($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value']);
...
*/
                            ...
                            default:
                                switch ($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value_type']) {
                                    case 0: // Unicode string
                                        if (substr(static::TrimConvert($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['name']), 0, 3) == 'WM/') {
                                            $thisfile_asf_comments[str_replace('wm/', '', strtolower(static::TrimConvert($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['name'])))] = array(static::TrimTerm($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value']));
                                        }
                                        break;
                ...
                default:
                    ...
                    if (static::GUIDname($NextObjectGUIDtext)) {
                        $info['warning'][] = 'unhandled GUID "'.static::GUIDname($NextObjectGUIDtext).'" {'.$NextObjectGUIDtext.'} in ASF header at offset '.($offset - 16 - 8);
                    } else {
            ...
            foreach ($thisfile_asf['stream_properties_object'] as $streamnumber => $streamdata) {
                switch ($streamdata['stream_type']) {
                    case \GETID3_ASF_AUDIO_MEDIA:
                        ...
                        $audiomediaoffset += 16;
                        $thisfile_audio['lossless'] = match ($thisfile_asf_audiomedia_currentstream['raw']['wFormatTag']) {
                            0x0001, 0x0163 => true,
                        };
        ...
        while ($this->ftell() < $info['avdataend']) {
            ...
            switch ($NextObjectGUID) {
                case \GETID3_ASF_DATA_OBJECT:
                    ...
                    $offset += 16;
                    $thisfile_asf_dataobject['fileid_guid']        = static::BytestringToGUID($thisfile_asf_dataobject['fileid']);
                ...
                case \GETID3_ASF_SIMPLE_INDEX_OBJECT:
                    ...
                    $offset += 16;
                    $thisfile_asf_simpleindexobject['fileid_guid']               = static::BytestringToGUID($thisfile_asf_simpleindexobject['fileid']);
                ...
                case \GETID3_ASF_INDEX_OBJECT:
                    ...
                    for ($IndexSpecifiersCounter = 0; $IndexSpecifiersCounter < $thisfile_asf_asfindexobject['index_specifiers_count']; $IndexSpecifiersCounter++) {
                        ...
                        $offset += 2;
                        $thisfile_asf_asfindexobject['index_specifiers'][$IndexSpecifiersCounter]['index_type_text'] = static::ASFIndexObjectIndexTypeLookup($thisfile_asf_asfindexobject['index_specifiers'][$IndexSpecifiersCounter]['index_type']);
                    }
                ...
                default:
                    // Implementations shall ignore any standard or non-standard object that they do not know how to handle.
                    if (static::GUIDname($NextObjectGUIDtext)) {
                        $info['warning'][] = 'unhandled GUID "'.static::GUIDname($NextObjectGUIDtext).'" {'.$NextObjectGUIDtext.'} in ASF body at offset '.($offset - 16 - 8);
                    } else {
                ...
                switch ($streamdata['information']) {
                    ...
                    default:
                        switch ($streamdata['type_raw']) {
                            case 1:
                                if (strstr(static::TrimConvert($streamdata['name']), 'Windows Media')) {
                                    $thisfile_video['dataformat'] = 'wmv';
        ...
        if (isset($thisfile_asf_codeclistobject['codec_entries'])) {
            foreach ($thisfile_asf_codeclistobject['codec_entries'] as $streamnumber => $streamdata) {
                switch ($streamdata['type_raw']) {
                    ...
                    case 1: // video
                        $thisfile_video['encoder'] = static::TrimConvert($thisfile_asf_codeclistobject['codec_entries'][$streamnumber]['name']);
                        break;

                    case 2: // audio
                        $thisfile_audio['encoder'] = static::TrimConvert($thisfile_asf_codeclistobject['codec_entries'][$streamnumber]['name']);

                        // AH 2003-10-01
                        $thisfile_audio['encoder_options'] = static::TrimConvert($thisfile_asf_codeclistobject['codec_entries'][0]['description']);
    ...
    public static function codecListObjectTypeLookup($CodecListType)
    {
        ...
        return ($lookup[$CodecListType] ?? 'Invalid Codec Type');
    }
    ...
    public static function FILETIMEtoUNIXtime($FILETIME, $round=true)
    {
        ...
        if ($round) {
            return intval(round(($FILETIME - 116_444_736_000_000_000) / 10_000_000));
        }
        return ($FILETIME - 116_444_736_000_000_000) / 10_000_000;
    }
    ...
    public static function WMpictureTypeLookup($WMpictureType)
    {
        ...
        if ($lookup === null) {
            ...
            $lookup = array_map(fn($str) => getid3_lib::iconv_fallback('UTF-8', 'UTF-16LE', $str), $lookup);
        }

        return ($lookup[$WMpictureType] ?? '');
    }
    ...
    public function HeaderExtensionObjectDataParse(&$asf_header_extension_object_data, &$unhandled_sections)
    {
        ...
        while ($objectOffset < strlen((string) $asf_header_extension_object_data)) {
            ...
            $offset += 16;
            $thisObject['guid_text'] = static::BytestringToGUID($thisObject['guid']);
            $thisObject['guid_name'] = static::GUIDname($thisObject['guid_text']);
            ...
            switch ($thisObject['guid']) {
                case \GETID3_ASF_EXTENDED_STREAM_PROPERTIES_OBJECT:
                    ...
                    $offset += 8;
                    $thisObject['start_time_unix']                   = static::FILETIMEtoUNIXtime($thisObject['start_time']);

                    $thisObject['end_time']                          = getid3_lib::LittleEndian2Int(substr($asf_header_extension_object_data, $offset, 8));
                    $offset += 8;
                    $thisObject['end_time_unix']                     = static::FILETIMEtoUNIXtime($thisObject['end_time']);
                    ...
                    for ($i = 0; $i < $thisObject['payload_extension_system_count']; $i++) {
                        ...
                        $offset += 16;
                        $payloadExtensionSystem['extension_system_id_text'] = static::BytestringToGUID($payloadExtensionSystem['extension_system_id']);
                ...
                case \GETID3_ASF_METADATA_OBJECT:
                    ...
                    for ($i = 0; $i < $thisObject['description_record_counts']; $i++) {
                        ...
                        switch ($descriptionRecord['data_type']) {
                            ...
                            case 0x0006: // GUID
                                $descriptionRecord['data_text'] = static::BytestringToGUID($descriptionRecord['data']);
                                break;
                        }
                ...
                default:
                    $unhandled_sections++;
                    if (static::GUIDname($thisObject['guid_text'])) {
                        $this->getid3->info['warning'][] = 'unhandled Header Extension Object GUID "'.static::GUIDname($thisObject['guid_text']).'" {'.$thisObject['guid_text'].'} at offset '.($offset - 16 - 8);
                    } else {
    ...
    public static function TrimTerm($string)
    {
        ...
        if (str_ends_with($string, "\x00\x00")) {
